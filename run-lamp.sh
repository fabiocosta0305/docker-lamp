...
exec start-stop-daemon --start  --chuid postgres:postgres --exec /usr/lib/postgresql/9.6/bin/postgres -- \
 --config_file=/etc/postgresql/9.6/main/postgresql.conf

exec start-stop-daemon --start  --exec /usr/sbin/nginx 
exec start-stop-daemon --start  --exec /usr/sbin/sshd 
